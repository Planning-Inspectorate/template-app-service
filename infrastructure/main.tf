module "primary_region" {
  #checkov:skip=CKV_TF_1: "Ensure Terraform module sources use a commit hash" - trusted source
...
resource "azurerm_key_vault" "main" {
  ...
  #checkov:skip=CKV2_AZURE_32: "Ensure private endpoint is configured to key vault" - Relies on VNet; raise a DevOps ticket
