resource "azurerm_mssql_server" "primary" {
  ...
  #checkov:skip=CKV2_AZURE_2: "Vulnerability Assessment (VA) is enabled on a SQL server" - required for TEST and PROD only
...
resource "azurerm_mssql_database" "primary" {
  ...
  #checkov:skip=CKV_AZURE_229: "Ensure the Azure SQL Database Namespace is zone redundant" - This is a premium feature, therefore not required on this project
